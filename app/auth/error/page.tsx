...
export default async function ErrorPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-black flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <Card className="bg-white/95 backdrop-blur-sm border-red-200">
          ...
          <CardContent className="text-center space-y-4">
            {params?.error ? (
              <p className="text-sm text-red-700 bg-red-50 p-3 rounded-md">Error: {params.error}</p>
            ) : (
